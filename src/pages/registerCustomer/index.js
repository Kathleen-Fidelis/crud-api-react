...
function RegisterCustomer(props) {
    ...
    //Ou passo a model q é um objeto, ou faço um pra cada atributo do objeto(tudo q está comentado)
    ...
    //metodo get, ou passo o objeto customer q está separado, ou passo cada atributo como o q esta comentado
    const register = () => {
                        ...
                        <Form>
                            <Form.Group className="mb-3" controlId="name">
                                ...
                                <Form.Control type="text"
                                    value={customer.name}               //conteudo do objeto(o q já tem nele)
